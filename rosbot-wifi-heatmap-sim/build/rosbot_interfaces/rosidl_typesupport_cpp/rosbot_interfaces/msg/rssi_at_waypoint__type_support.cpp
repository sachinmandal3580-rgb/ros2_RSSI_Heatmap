...
static const _RssiAtWaypoint_type_support_symbol_names_t _RssiAtWaypoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rosbot_interfaces, msg, RssiAtWaypoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosbot_interfaces, msg, RssiAtWaypoint)),
  }
};
...
{
  return &::rosbot_interfaces::msg::rosidl_typesupport_cpp::RssiAtWaypoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rosbot_interfaces, msg, RssiAtWaypoint)() {
  return get_message_type_support_handle<rosbot_interfaces::msg::RssiAtWaypoint>();
}
