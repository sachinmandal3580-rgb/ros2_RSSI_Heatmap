...
#include "rosbot_interfaces/msg/detail/rssi_at_waypoint__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rosbot_interfaces::msg::RssiAtWaypoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rosbot_interfaces::msg::RssiAtWaypoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rosbot_interfaces::msg::RssiAtWaypoint *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RssiAtWaypoint__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rosbot_interfaces::msg::RssiAtWaypoint *>(
...
static size_t _RssiAtWaypoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RssiAtWaypoint(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RssiAtWaypoint__callbacks = {
...
static rosidl_message_type_support_t _RssiAtWaypoint__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RssiAtWaypoint__callbacks,
...
{
  return &rosbot_interfaces::msg::typesupport_fastrtps_cpp::_RssiAtWaypoint__handle;
}
